...
As an alternative, you can also download dataset_real.csv and dataset_images_as_columns.csv to explore and/or reproduce the attached Jupyter notebooks (.ipynb).

You are free to download and modify the code to improve its efficiency or for any other purpose you see fit.
