...
for j in range(1,32):
    ...
    for i in range(len(dict_lats[0])):
        for k in range(0,no_beams):
            lat_bk_M10 = dict_lats[k][i]
            long_bk_M10 = dict_longs[k][i]
