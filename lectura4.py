...
for i in range(len(QDC_Ts_38_2_M10)):
    P_n_38_2.append(power_noise(QDC_Ts_38_2_M10[i]))

plt.figure(figsize=(7,5))  
plt.plot(X1, P_n_38_2, c='y')
plt.xlim(0,24)
plt.ylim(0,0.00000043)
plt.xlabel('Universal Time [h] (UTC)')
...
P_n_45=[]
for i in range(len(QDC_Ts_38_2_M10)):
    P_n_30.append(power_noise(QDC_T30_M10[i]))
    P_n_30_5.append(power_noise(QDC_T30_5_M10[i]))
    P_n_31.append(power_noise(QDC_T31_M10[i]))
    P_n_31_5.append(power_noise(QDC_T31_5_M10[i]))
    P_n_32.append(power_noise(QDC_T32_M10[i]))
    P_n_32_5.append(power_noise(QDC_T32_5_M10[i]))
    P_n_33.append(power_noise(QDC_T33_M10[i]))
    P_n_33_5.append(power_noise(QDC_T33_5_M10[i]))
    P_n_34.append(power_noise(QDC_T34_M10[i]))
    P_n_34_5.append(power_noise(QDC_T34_5_M10[i]))
    P_n_35.append(power_noise(QDC_T35_M10[i]))
    P_n_35_5.append(power_noise(QDC_T35_5_M10[i]))
    P_n_36.append(power_noise(QDC_T36_M10[i]))
    P_n_36_5.append(power_noise(QDC_T36_5_M10[i]))
    P_n_37.append(power_noise(QDC_T37_M10[i]))
    P_n_37_5.append(power_noise(QDC_T37_5_M10[i]))
    P_n_38.append(power_noise(QDC_T38_M10[i]))
    P_n_38_5.append(power_noise(QDC_T38_5_M10[i]))
    P_n_39.append(power_noise(QDC_T39_M10[i]))
    P_n_39_5.append(power_noise(QDC_T39_5_M10[i]))
    P_n_40.append(power_noise(QDC_T40_M10[i]))
    P_n_40_5.append(power_noise(QDC_T40_5_M10[i]))
    P_n_41.append(power_noise(QDC_T41_M10[i]))
    P_n_41_5.append(power_noise(QDC_T41_5_M10[i]))
    P_n_42.append(power_noise(QDC_T42_M10[i]))
    P_n_42_5.append(power_noise(QDC_T42_5_M10[i]))
    P_n_43.append(power_noise(QDC_T43_M10[i]))
    P_n_43_5.append(power_noise(QDC_T43_5_M10[i]))
    P_n_44.append(power_noise(QDC_T44_M10[i]))
    P_n_44_5.append(power_noise(QDC_T44_5_M10[i]))
    P_n_45.append(power_noise(QDC_T45_M10[i]))
