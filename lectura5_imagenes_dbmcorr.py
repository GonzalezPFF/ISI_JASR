...
for i in range(len(QDC_Ts_38_2_M10)):
    P_n_38_2_M10.append(power_dbm(power_noise(QDC_Ts_38_2_M10[i])))
...
for i in range(len(lat_b1_list_M10)):
    ...
    P_n_b1_38_2_M10.append(power_dbm(power_noise(mean_b1_M10)))
    ...
    P_n_b2_38_2_M10.append(power_dbm(power_noise(mean_b2_M10)))
    ...
    P_n_b3_38_2_M10.append(power_dbm(power_noise(mean_b3_M10)))
    ...
    P_n_b4_38_2_M10.append(power_dbm(power_noise(mean_b4_M10)))
    ...
    P_n_b5_38_2_M10.append(power_dbm(power_noise(mean_b5_M10)))
    ...
    P_n_b6_38_2_M10.append(power_dbm(power_noise(mean_b6_M10)))
    ...
    P_n_b7_38_2_M10.append(power_dbm(power_noise(mean_b7_M10)))
    ...
    P_n_b8_38_2_M10.append(power_dbm(power_noise(mean_b8_M10)))
